          ...
          <Nav>
            ...
            >
              <NavDropdown.Item href="/profile">
                <FaUser className="navIcon" size="1.4em" /> Profile
              </NavDropdown.Item>
              <NavDropdown.Item href="/history">
                <BsGraphUp className="navIcon" size="1.3em" /> History
              </NavDropdown.Item>
              <NavDropdown.Item href="/record-workout">
                <FaRunning className="navIcon" size="1.5em" /> Workout
              </NavDropdown.Item>
              <NavDropdown.Item href="/chat">
                <IoChatbubbleEllipsesSharp className="navIcon" size="1.4rem" />{" "}
                Chat
              </NavDropdown.Item>
              <NavDropdown.Item onClick={handleLogout}>
                <RiLogoutCircleLine className="navIcon" size="1.4rem" /> Logout
              </NavDropdown.Item>
            </NavDropdown>
          </Nav>
        </Navbar.Collapse>
