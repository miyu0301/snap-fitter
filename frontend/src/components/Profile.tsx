...
const Profile = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append("username", dbUser.username);
      formData.append("email", dbUser.email);
      formData.append("goal_id", dbUser.goal_id.toString());
      formData.append("level_id", dbUser.level_id.toString());
      formData.append("gender", dbUser.gender.toString());
      formData.append("birthday", dbUser.birthday);
      formData.append("height", dbUser.height);
      formData.append("weight", dbUser.weight);

      if (selectedImage) {
        formData.append("image", selectedImage, selectedImage.name);
      }

      await user.handleDBUpdate(formData);
      ...
      <div className="container mt-80">
        <div className="row">
          <div className="col-sm-12 col-md-3 border-right md-hide">
            ...
            <Link className="profile-link profile-active-item" to="#">
              <FaUserCircle size="1.2em" /> Profile Info
            </Link>
            <Link className="profile-link" to="/record-workout">
              <FaRunning size="1.5em" /> Record Workout
            </Link>
            <Link className="profile-link" to="/history">
              <BsGraphUp size="1.2em" /> History
            </Link>
            <Link className="profile-link" to="/chat">
              <IoChatbubbleEllipsesOutline size="1.5em" /> Chat
            </Link>
            <Button className="mt-4 mb-4 no-button" onClick={handleLogout}>
            ...
            <div className="container">
              ...
              <div className="position-relative profile-image-container mb-4">
                <label htmlFor="imageInput">
                  <img
                    ...
                    style={{ width: "7em", height: "7em", cursor: "pointer" }}
                  />
                  <input
                    id="imageInput"
                    type="file"
                ...
                <div className="mb-3 col-sm-12 md-text-center">
                  <Button
                    variant=""
                    className={`button ${
                      selectedGender === 1 ? "btn-solid" : "btn-outline"
                    }`}
                  ...
                  <Button
                    variant=""
                    className={`button ${
                      selectedGender === 2 ? "btn-solid" : "btn-outline"
                    } ms-2`}
              ...
              <form onSubmit={handleSubmit} className="row">
                ...
                <div className="mb-3 col-sm-12 col-md-6">
                  ...
                  <div className="input-group">
                    <input
                      ...
                      id="birthday"
                      name="birthday"
                      value={formatDate(dbUser.birthday)}
                      onChange={handleChange}
                    />
                    <span className="input-group-text">
                      <FaBirthdayCake />
                ...
                <div className="mb-3 col-md-12 text-center">
                  <button type="submit" className="button btn-solid mt-4 w-50">
                    Save Changes
                  </button>
                </div>
              </form>
